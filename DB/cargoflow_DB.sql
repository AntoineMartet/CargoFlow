...
INSERT INTO `employees` (`id`, `lastName`, `firstName`, `email`, `password`, `phoneNumber`, `role`, `employeeNumber`) VALUES
	...
	(3, 'Lefevre', 'Olivia', 'olivia.lefevre@email.com', '958ac779033bf364bdf8325d2fe68197', '0041219876543', 'Service Client', 'E1003'),
	...
	(6, 'Lastname', 'Firstname', 'firstname.lastname@email.com', '8e6fffd4d1ec982d2d9f8576074a9b2d', '0041915576521', 'Gestionnaire', 'E1006');
...
INSERT INTO `warehouses_have_days` (`id`, `warehouse_id`, `day_id`, `openingHours`, `closingHours`) VALUES
	...
	(2, 1, 2, '08:30:00', '17:30:00'),
	(3, 1, 3, '10:00:00', '19:00:00'), 
	(4, 1, 4, '08:00:00', '16:45:00'),
	(5, 1, 5, '06:00:00', '22:30:00'),
	(6, 1, 6, '09:30:00', '18:30:00'),
	(7, 2, 1, '09:00:00', '18:00:00'),
	(8, 2, 2, '08:30:00', '17:30:00'),
	(9, 2, 3, '10:00:00', '19:00:00'),
	(10, 2, 4, '08:00:00', '16:45:00'),
	(11, 2, 5, '06:00:00', '22:30:00'),
	(12, 2, 6, '09:30:00', '18:30:00'),
	(13, 3, 1, '09:00:00', '18:00:00'),
	(14, 3, 2, '08:30:00', '17:30:00'),
	(15, 3, 3, '10:00:00', '19:00:00'),
	(16, 3, 4, '08:00:00', '16:45:00'),
	(17, 3, 5, '06:00:00', '22:30:00'),
	(18, 3, 6, '09:30:00', '18:30:00'),
	(19, 4, 1, '09:00:00', '18:00:00'),
	(20, 4, 2, '08:30:00', '17:30:00'),
	(21, 4, 3, '10:00:00', '19:00:00'),
	(22, 4, 4, '08:00:00', '16:45:00'),
	(23, 4, 5, '06:00:00', '22:30:00'),
	(24, 5, 1, '09:00:00', '18:00:00'),
